...
class chooseReportPage:
    ...
    def create_catagory_menu(self):
        catagory_options = ["None", "Mobile", "Laptop","Others"]
    ...
    def open_selected_page(self):
        ...
        if selected_category == "Mobile":
            ...
            self.show_reportMobile()

        elif selected_category == "Laptop":
            self.show_reportLaptop()

        elif selected_category == "Others":
            self.show_reportOthers()
    ...
    def showChooseReport(self):
        self.master.wait_window(self.master)

    def show_reportMobile(self):
        start_mobile = reportMobilePage(self.master ,self.userId)
        start_mobile.showReportMobile()

    def show_reportOthers(self):
        start_others = reportOthersPage(self.master ,self.userId)
        start_others.showReportOthers()

    def show_reportLaptop(self):
        start_laptop = reportLaptopPage(self.master , self.userId)
        start_laptop.showReportLaptop()

if __name__=="__main__":
    master = Tk()
    master.resizable(False, False)
    app=chooseReportPage(master,2)
    master.mainloop()
